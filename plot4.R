...
plot(datetime, subdf$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)

plot(datetime, subdf$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
plot(datetime, subdf$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
